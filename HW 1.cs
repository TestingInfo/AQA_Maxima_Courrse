...
/* Реализуйте алгоритм такой задачи

Программа получает на вход имя, возраст и размер запрашиваемого кредита
...
В других случаях кредит не выдается Выдача кредита - это вывод в консоль сообщения, что кредит выдан.
 */
class Program
{
